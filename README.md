...
* [Thư viện Đại học Harvard, Mỹ](https://hollis.harvard.edu/primo-explore/jsearch?query=any,contains,programming&tab=jsearch_slot&vid=HVD&lang=en_US&offset=0&journals=any,programming)
* [Thư viện Học viện Công nghệ MIT, Mỹ](https://libraries.mit.edu/), [MIT E-book](https://libguides.mit.edu/c.php?g=176252&p=1159406)
* [Thư viện Học viện Công nghệ California, Mỹ](https://www.library.caltech.edu/)
* [Thư viện Đại học Stanford, Mỹ](https://library.stanford.edu/)
* [Thư viện Đại học Chicago, Mỹ](https://www.lib.uchicago.edu/)
* [Thư viện Đại học Cambridge, Anh](https://www.lib.cam.ac.uk/)
* [Thư viện Đại học Oxford, Anh](https://www.ox.ac.uk/research/libraries?wssl=1)
* [Thư viện Đại học RMIT, Úc](https://www.rmit.edu.au/library)
* [Thư viện Đại học Kent, Anh](https://www.kent.ac.uk/library/)
* [Thư viện Đại học King, Anh](https://www.king.edu/academics/king-university-libraries/)
* [Thư viện Đại học Boston, Anh](https://www.bu.edu/library/)
* [Thư viện học viện Công nghệ Zurich, Thụy Sĩ](http://www.library.ethz.ch/)
* [Thư viện Đại học ShangHai, TQ](http://www.lib.shu.edu.cn/en/index.php)
...
* Danh sách các trang web học liệu mở Việt Nam và học liệu mở thế giới:
  ...
  + [Over 13 000 free courses from top universities worldwide](https://www.classcentral.com)
  + [400+ Online Courses With Real College Credit](https://www.classcentral.com/report/free-for-credit-moocs/)
  + [MOOCs from Great Universities](http://www.openculture.com/free_certificate_courses)
...
* [Community Network](https://en.wikipedia.org/wiki/Community_network)
  ...
  Là một hệ thống máy tính hỗ trợ các cộng người, cộng đồng mạng, cộng đồng internet, mạng xã hội thuộc các khu vực địa lý khác nhau bằng việc cung cấp, hỗ trợ và phát triển mở rộng cộng đồng mạng sẵn có như Blockchain, tần số FM, radio, đài truyền hình đến khắp mọi nơi.
* https://www.whoishostingthis.com/blog/2015/03/09/start-your-own-isp/
* Build radio station: https://radio.co/radio-university/create-your-own-radio-station, https://lrn.fm/broadcast/station/, https://freifunk.net/en/how-to-join/create-a-new-freifunk-community/, [group of neighbors created their own Internet service](https://arstechnica.com/information-technology/2015/11/how-a-group-of-neighbors-created-their-own-internet-service/)
* Build a digital future: https://www.internetsociety.org/issues/community-networks/
* [Create Your Own Private Wireless Network, Anytime, Anywhere](http://blog.dlink.com/how-to-create-your-own-private-wireless-network-anytime-anywhere/)
* 
#### Very Large Scale Integration
#### Hardware
#### Hardware hacking
* [Hacked Our Coffee Machine with JavaScript](https://moin.world/2017/04/01/how-we-hacked-our-coffee-machine-with-javascript/), https://github.com/dkundel/about-me
#### Printed circuit board
#### Hardware Design
#### Motherboard: Bo mạch chủ
#### Supervisory Control and Data Acquisition (SCADA): Hệ thống thu thập, điều khiển và giám sát dữ liệu
#### Programmable Logic Controller (PLC)
#### Firmware
#### Application-specific integrated circuit (ASIC): Mạch tích hợp
#### Tester: Kiểm thử phần mềm
#### Field Programmable gate array (FPGA): Mạch có thể lập trình được
#### Google
+ [List of Google products](https://www.google.com/about/products/)
#### Oracle
+ [List of Oracle products](https://www.oracle.com/products/oracle-a-z.html)
+ [List of Oracle product](https://www.oracle.com/products/)
#### IBM
+ [Products by category](https://www-01.ibm.com/software/sw-bycategory/indexS.html)
+ [List of IBM products](https://en.wikipedia.org/wiki/List_of_IBM_products)
#### Microsoft
+ [List of Microsoft software](https://en.wikipedia.org/wiki/List_of_Microsoft_software)
+ [List of Microsoft Office programs](https://en.wikipedia.org/wiki/List_of_Microsoft_Office_programs)
+ [List of Microsoft Product](/Assets/Microsoft%20Product%20List%202012.pdf)
#### Amazon
+ [Amazon Web Service product](https://aws.amazon.com/products/)
#### Facebook
+ [Products](https://www.minterest.com/list-of-all-facebook-products-and-services/)
#### Adobe
+ [List of Adobe software](https://en.wikipedia.org/wiki/List_of_Adobe_software)
+ [List of Adobe Category](https://www.adobe.com/sea/products/catalog.html)
#### SAP
+ [List of SAP products](https://www.sap.com/sea/products-a-z.html)
#### Maxon
+ [List of Maxon products](https://www.maxon.net/en/products/overview/)
#### Autodesk
+ [List of Autodesk products](https://www.autodesk.com/products)
...
* [Nên chọn thuật toán máy học như thế nào?](https://bloss.sas.com/content/subconsconsmusings/2017/04/12/machine-learning-alerskym-use/)
...
* [Gradient lan truyền ngược theo thời gian và mất dần](http://www.wildml.com/2015/10/recurrent-neural-networks-tutorial-part-3-backpropagation-through-time-and-vanishing-gradients/)
...
* [**Building Visual Programming Language**](http://web.engr.oregonstate.edu/~burnett/vpl.html)

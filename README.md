...
* [Motherboard](#motherboard-bo-mạch-chủ): Bo mạch chủ
* [Supervisory Control and Data Acquisition (SCADA)](#supervisory-control-and-data-acquisition-scada-hệ-thống-thu-thập-điều-khiển-và-giám-sát-dữ-liệu): Hệ thống thu thập, điều khiển và giám sát dữ liệu
* [Programmable Logic Controller (PLC)](#programmable-logic-controller-plc): Ladder logic, instruction, function chart 
* [Firmware](#firmware)
* [Application-specific integrated circuit (ASIC)](#application-specific-integrated-circuit-asic-mạch-tích-hợp): Mạch tích hợp
* [Tester](#tester-kiểm-thử-phần-mềm): Kiểm thử phần mềm
* [Field Programmable gate array (FPGA)](#field-programmable-gate-array-fpga-mạch-có-thể-lập-trình-được): Mạch có thể lập trình được
* [Google](#google)
* [Oracle](#oracle)
* [IBM](#ibm)
* [Microsoft](#microsoft)
